...
static SyntaxTreeErrors simplifyNoVarsSubtree(SyntaxTree* tree, size_t newLeftNode, size_t newRightNode,
                                             const Function* func, size_t* resultNodeInd) {
    double one = getSyntaxTreeNodePtr(tree,  newLeftNode)->doubleData;
    double two = getSyntaxTreeNodePtr(tree, newRightNode)->doubleData;
